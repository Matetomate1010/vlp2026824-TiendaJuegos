            ...
            <tbody>
                <?php while ($game = $games->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="index.php?edit_id=<?php echo $game['id']; ?>">Editar</a> |
                            <a href="index.php?delete_id=<?php echo $game['id']; ?>" onclick="return confirm('¿Estás seguro de que deseas eliminar este juego?');">Eliminar</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
